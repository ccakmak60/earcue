...
- Memory view order (`memory-view.tsx`): header, the search form (button "Search") and its answers, "What earcue knows about you", "Ask earcue", then "What earcue has learned". The search stays the first thing on the view; the profile opens the part about what earcue holds.
