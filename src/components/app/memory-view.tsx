...
import { BrainIcon, FileTextIcon, HashIcon, LockIcon, MailIcon, MessageCircleIcon, SearchIcon } from "lucide-react";
...
export function MemoryView({ active, knowledge: k, onAddSource }: { active: boolean; knowledge: KnowledgeState; onAddSource: () => void }) {
  ...
  return (
    <ViewSection active={active} labelledBy="memoryTitle">
      ...
      <PeopleSection active={active} version={memories} onForget={forget} onCorrect={correct} />
